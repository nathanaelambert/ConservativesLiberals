## Project Overview
This project explores political discourse on reddit.

We analyse the following elements:
- topic modelling between liberals and conservatives (Oscar)
- topic modelling between subreddits (Nathanaël)
- sentiment analysis (André)
- shared posts between subreddits analysis (Baptiste)

## Project Structure
Our data is in the folder data/
the raw data we downloaded from kaggle is reddit_posts.csv (we removed 15% of the data to respect the ethics committee feedback)
